    ...
    <section className="portfolio--section mt-14" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <h1 className="section--heading">Some works</h1>
        </div>
        <div>
      ...
      <div className="portfolio--section--container">
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content gap-[32px] items-start flex-col max-w-[300px] flex mt-8">
              <div>
                <h3 className="portfolio--section--title text-[#efdca7] font-bold">Weather application</h3>
                <p className="text-md text-white">Simple weather application in reactJs</p>
              </div>
            </div>
          </div>
